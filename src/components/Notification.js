...
const NotificationText = ({type, status, context}) => {
    ...
    if (type === 'signin' && status === 'success' && context.member) {
        ...
        return (
            <p>
                Bienvenido de nuevo{(firstname ? ', ' + firstname : '')}!<br />Has iniciado sesión correctamente.
            </p>
        );
        ...
        return (
            <p>
                ¡Bien! Tu correo electrónico se ha actualizado.
            </p>
        );
        ...
        return (
            <p>
                ¡Fantástico! Revisa tu correo electrónico para iniciar sesión con el enlace mágico.
            </p>
        );
        ...
        if (context.member) {
            return (
                <p>
                    La actualización del plan ha sido cancelada.
                </p>
            );
        }
        return (
            <p>
                El pago del plan fue cancelado.
            </p>
        );
    }
    return (
