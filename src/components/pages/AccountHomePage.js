...
const AccountWelcome = () => {
    ...
    return (
        <div className='gh-portal-section'>
            <p className='gh-portal-text-center gh-portal-free-ctatext'>Actualmente disfrutas de un plan gratuito, actualiza a una suscripción de pago para acceder a todo.</p>
            <SubscribeButton />
        </div>
    );
};
