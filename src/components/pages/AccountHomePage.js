...
function EmailPreferencesAction() {
    ...
    return (
        <section>
            <div className='gh-portal-list-detail'>
                <h3>Boletín</h3>
                <p>Actualizar preferencias de correo electrónico</p>
            </div>
...
const AccountWelcome = () => {
    ...
    return (
        <div className='gh-portal-section'>
            <p className='gh-portal-text-center gh-portal-free-ctatext'>Actualmente tienes un plan gratuito, actualiza a una suscripción de pago para el acceso completo.</p>
            <SubscribeButton />
        </div>
    );
};
