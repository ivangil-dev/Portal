...
export default class MagicLinkPage extends React.Component {
    ...
    renderFormHeader() {
        ...
        let popupDescription = `Si el correo electrónico no llega en 3 minutos, ¡asegúrate de comprobar tu carpeta de spam!`;

        if (this.context.lastPage === 'signup') {
            popupTitle = `Ahora revisa tu correo electrónico!`;
            popupDescription = `Para completar el registro, haz clic en el enlace de confirmación en tu email. Si no llega en 3 minutos, ¡revisa tu carpeta de spam!`;
        }
