...
export default class SigninPage extends React.Component {
        ...
        const fields = [
            {
                type: 'email',
                value: state.email,
                placeholder: 'enrique@ejemplo.com',
                label: 'Email',
                name: 'email',
                required: true,
    ...
    renderSubmitButton() {
        ...
        let label = isRunning ? 'Enviando enlace de acceso...' : 'Continuar';
    ...
    renderSignupMessage() {
        ...
        return (
            <div className='gh-portal-signup-message'>
                ...
                <button className='gh-portal-btn gh-portal-btn-link' style={{color: brandColor}} onClick={() => this.context.onAction('switchPage', {page: 'signup'})}><span>Registrarme</span></button>
            </div>
        );
    }
