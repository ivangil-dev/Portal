    ...
    renderSignupMessage() {
        ...
        return (
            <div className='gh-portal-signup-message'>
                ...
                <button className='gh-portal-btn gh-portal-btn-link' style={{color: brandColor}} onClick={() => this.context.onAction('switchPage', {page: 'signup'})}><span>Registrate gratis</span></button>
            </div>
        );
    }
