            ...
            return (
                <section>
                    <div className='gh-portal-section'>
                        <p className='gh-portal-invite-only-notification'>Este sitio es accesible solo por invitación, comuníquese con el propietario para acceder.</p>
