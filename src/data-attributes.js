        ...
        function clickHandler(event) {
            ...
            return fetch(`${siteUrl}/members/api/session`, {
                ...
                if (res.ok) {
                    ...
                    if (errorEl) {
                        errorEl.innerText = 'Hubo un error al cancelar tu suscripción, inténtalo de nuevo.';
                    }
                }
            });
        }
        ...
        function clickHandler(event) {
            ...
            return fetch(`${siteUrl}/members/api/session`, {
                ...
                if (res.ok) {
                    ...
                    if (errorEl) {
                        errorEl.innerText = 'Hubo un error al continuar tu suscripción, inténtalo de nuevo.';
                    }
                }
            });
        }
