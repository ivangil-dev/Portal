...
describe('Member Data attributes:', () => {
    ...
    describe('data-members-form', () => {
        test('allows free signup', () => {
            ...
            expect(window.fetch).toHaveBeenCalledWith('https://portal.localhost/members/api/send-magic-link/', {body: '{"email":"enrique@ejemplo.com","emailType":"signup","labels":["Gold"],"name":"Jamie Larsen"}', headers: {'Content-Type': 'application/json'}, method: 'POST'});
        });
    });
